...
class ViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        button.frame = CGRect(x: 30, y: view.frame.size.height - 50 - view.safeAreaInsets.bottom , width: view.frame.size.width - 60, height: 60)
    }
    ...
    override func viewDidLoad() {
        ...
        imageView.frame = CGRect(x: 0, y: 0, width: 360, height: 640)
    ...
    func getRandomPhoto()
    {
        let urlstr = "https://source.unsplash.com/random/1080x1920"
